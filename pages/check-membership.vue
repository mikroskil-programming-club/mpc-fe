...
<template>
  <main>
    <div class="max-w-[calc(384px+16px)] mx-auto mt-12 px-4">
      <h2 class="text-2xl font-bold mb-8 text-center">Check Membership</h2>
      <label for="price" class="block text-sm font-medium leading-6 text-gray-900" style="display: none;">NIM</label>
